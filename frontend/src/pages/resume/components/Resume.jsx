...
const CANDIDATE_JSON_DATA = [
  {
    ...
    avatar:
      "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExNXMweHBwYzM2azR1YTYxcGNsOGZmNHNqc3I0b3I0dGl3emJkbzNsNSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/SWoSkN6DxTszqIKEqv/giphy.gif",
    ...
    resumeLink:
      "https://drive.google.com/file/d/1llcv-vxbQLPxyZv6jMHcKHxGoYyC0v7O/view?usp=sharing",
    resumeDownload:
      "https://docs.google.com/uc?export=download&id=1B6_b80j8uR70tLzX3h-yV069G917X69V",
    actualResponses: {
      "what are aditya's core frontend proficiencies":
        "Aditya's core frontend proficiencies include React.js, modern JavaScript (ES6+), Tailwind CSS, React Hooks, and Context API. He specializes in building performant and accessible web interfaces.",
      "can you describe his webrtc/socket.io frontend integration":
        "On the frontend, Aditya integrated Socket.io for real-time signaling events and designed an adaptive video grid layout for 2 to 8+ participants with live controls. He also handled WebRTC media streams directly in the browser.",
      "does aditya have experience with design system tokens":
        "Yes, Aditya built a reusable component library utilizing Tailwind CSS design tokens (product cards, filters, drawers) which reduced UI development times significantly.",
    },
    suggestedPrompts: [
      "What are Aditya's core frontend proficiencies?",
      "Can you describe his WebRTC/Socket.io frontend integration?",
  ...
  },
  {
    ...
    avatar:
      "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExM25zM2Jic2xwaTF6OWZvMDF6dWhzdzVtOGM2N2ZmazNvcDVwenZucSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/L1R1tvI9svkIWwpVYr/giphy.gif",
    email: "adityapatildev21@gmail.com",
    phone: "+91 8855040187",
    location: "Pune, Maharashtra, India",
    skills: [
    ...
    resumeLink:
      "https://drive.google.com/file/d/1GI5cvs3UaS72tO2Ng4GOm_ssENakzifL/view?usp=sharing",
    resumeDownload:
      "https://docs.google.com/uc?export=download&id=1B6_b80j8uR70tLzX3h-yV069G917X69V",
    actualResponses: {
      "what full-stack database integrations does aditya use":
        "Aditya implements dual-layer database strategies: MongoDB Atlas and MySQL for persistent metadata, Redis for conversation context caching and e-commerce listing caching (improving latency by 45%).",
      "how does aditya implement security and auth in his stack":
        "Aditya implements secure JWT authentication with access/refresh token rotation, bcrypt password hashing, express-rate-limit, Helmet.js security headers, and input validation meeting OWASP standards.",
      "describe aditya's experience with aws and docker deployment":
        "Aditya containerized frontend and backend services using Docker/Docker Compose. He deployed these systems on AWS EC2 behind Nginx reverse-proxies, utilizing AWS S3 & CloudFront for static asset caching, and automated CI/CD via GitHub Actions.",
    },
    suggestedPrompts: [
      "What full-stack database integrations does Aditya use?",
      "How does Aditya implement security and auth in his stack?",
  ...
  },
  {
    ...
    avatar:
      "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExMTBvcHVldzVvYThoNThnZWZnbGR0ZTVxZjNiZmZ3djF6Z2szYjYyciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qgQUggAC3Pfv687qPC/giphy.gif",
    email: "adityapatildev21@gmail.com",
    phone: "+91 8855040187",
    location: "Pune, Maharashtra, India",
    skills: [
    ...
    resumeLink:
      "https://drive.google.com/file/d/1irjoe80fv6_vkSUVQ1dk3Qk3n2WLafBU/view?usp=sharing",
    resumeDownload:
      "https://docs.google.com/uc?export=download&id=1B6_b80j8uR70tLzX3h-yV069G917X69V",
    actualResponses: {
      "explain aditya's backend api optimization strategies":
        "Aditya implements Redis caching on high-traffic listing endpoints (reducing response time from 320ms to 175ms), uses Nginx for upstream load management, and utilizes AWS CloudFront CDN for edge-cached static assets.",
      "how does aditya design prompt engineering pipelines":
        "Aditya engineers structured prompt engineering pipelines with domain-specific rule injection and dynamic response filtering, reducing off-topic LLM outputs by ~60%.",
      "what real-time signaling technologies does aditya deploy":
        "Aditya builds WebRTC peer-to-peer signaling servers in Node.js with Socket.io, configuring STUN/TURN relay fallbacks and managing room sessions entirely from the server.",
    },
    suggestedPrompts: [
      "Explain Aditya's backend API optimization strategies?",
      "How does Aditya design prompt engineering pipelines?",
...
`;
  ...
  const processAIQuery = async (promptText) => {
    ...
    if (isTyping) {
      triggerToast(
        "Processor Engaged",
        "Please wait for the current stream animation to finish.",
        true,
      );
      return;
    }
      ...
      if (charIndex < textString.length) {
        ...
        setChatHistories((prev) => {
          ...
          return {
            ...prev,
            [docId]: hist.map((m) =>
              m.id === messageId ? { ...m, text: currentString, isFake } : m,
            ),
          };
        });
      } else {
        ...
        <main className="max-w-7xl w-full mx-auto px-4 py-16 flex-grow flex flex-col justify-center animate-fadeIn">
          <div className="text-center max-w-lg mx-auto mb-12">
            ...
            <p className="text-xs text-slate-500 mt-2 font-light">
              Choose an engineering candidate to analyze their verified skills
              page, export documents, and load the dynamic AI chat widget.
            </p>
          </div>
            ...
            {CANDIDATE_JSON_DATA.map((doc) => (
              <div
                ...
                onClick={() => {
                  ...
                  triggerToast(
                    "Dossier Initialized",
                    `Opened secure preview workspace for ${doc.name}.`,
                  );
                }}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-[#6527D0] font-mono font-bold mt-0.5 uppercase tracking-wide">
                    {activeDoc.role}
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2 p-2.5 bg-slate-50 border-b border-slate-200/80">
                {[1, 2, 3].map((page) => (
                  ...
                  >
                    ...
                    <div
                      className={`w-6 h-7 rounded border flex flex-col justify-between p-0.5 overflow-hidden transition-all ${
                        activePage === page
                          ? "bg-indigo-50/50 border-[#6527D0]"
                    ...
                    >
                      ...
                      {page === 1 && (
                        <div className="h-1 w-2 bg-[#6527D0]/40 rounded-full" />
                      )}
                      {page === 2 && (
                        <div className="h-1 w-full bg-emerald-500/30 rounded-full" />
                      )}
                      {page === 3 && (
                        <div className="h-1.5 w-1.5 bg-amber-500/40 rounded-full self-end" />
                      )}
                    </div>
                ...
                <div className="bg-white border border-slate-200 p-8 rounded-2xl min-h-full flex flex-col justify-between shadow-sm relative overflow-hidden">
                    ...
                    <div className="space-y-5 animate-fadeIn">
                      ...
                      <div className="border-b-2 border-slate-100 pb-5 flex items-start justify-between gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          />
                          <div>
                            <h2 className="text-xl font-black text-slate-955 leading-none">
                              {activeDoc.name}
                            </h2>
                        ...
                        <div className="text-[9px] text-slate-400 font-mono space-y-0.5 text-right hidden sm:block">
                          <div className="flex items-center justify-end gap-1">
                            <Mail size={9} /> {activeDoc.email}
                          </div>
                          <div className="flex items-center justify-end gap-1">
                            <Phone size={9} /> {activeDoc.phone}
                          </div>
                          <div className="flex items-center justify-end gap-1">
                            <MapPin size={9} /> {activeDoc.location}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                        <div className="md:col-span-2 space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-600 leading-relaxed font-light">
                              Dedicated to designing modular architectures
                              optimized for high-performance and low-latency
                              interaction cycles. Prioritizes accessibility,
                              systematic design tokens, and rigorous integration
                              standards.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="relative border-l border-slate-200 pl-5 ml-1.5 space-y-5">
                        {activeDoc.experience.map((exp, index) => (
                          <div key={index} className="relative">
                            ...
                            <span className="text-[10px] text-[#6527D0] font-bold block mt-0.5">
                              {exp.company}
                            </span>
                  ...
                  {activePage === 3 && (
                    <div className="space-y-5 animate-fadeIn">
                      <div className="border-b border-slate-100 pb-3">
                        <h2 className="text-xs font-extrabold uppercase tracking-widest text-[#6527D0] flex items-center gap-1.5">
                          <Award size={12} /> Tech Skill Metrics &
                          Certifications
                        </h2>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {activeDoc.skills.map((skill, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="space-y-1.5 bg-slate-50/50 p-3 rounded-xl border border-slate-100"
                            >
                              <div className="flex items-center justify-between text-[10px]">
                                <span className="font-bold text-slate-800">
                                  {skill}
                                </span>
                                <span className="font-mono font-bold text-[#6527D0] bg-[#6527D0]/5 px-1.5 py-0.5 rounded">
                                  {score}%
                                </span>
                              </div>
                              <div className="w-full h-1.5 bg-slate-200/80 rounded-full overflow-hidden">
                                <div
                                  className="h-full bg-[#6527D0] rounded-full"
                                  style={{ width: `${score}%` }}
                                />
                              </div>
                            </div>
                      ...
                      <div className="bg-indigo-50/30 border border-[#6527D0]/10 p-4 rounded-xl flex items-start gap-3 mt-3">
                        <Code
                          size={16}
                          className="text-[#6527D0] mt-0.5 flex-shrink-0"
                        />
                        <div>
                          <h5 className="text-[11px] font-bold text-slate-850">
                            Dynamic Metadata Lock
                          </h5>
                          <p className="text-[10px] text-slate-500 font-light mt-0.5 leading-relaxed">
                            The information displayed in this structural
                            portfolio schema has been dynamically indexed as
                            vector weights inside the AI chatbot context.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="md:col-span-4 bg-white border border-slate-200 rounded-3xl flex flex-col h-full overflow-hidden shadow-sm relative">
              ...
              <div className="px-4 py-3.5 border-b border-slate-100 bg-white flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-[10px] font-extrabold text-slate-900 tracking-wider uppercase font-mono">
                      Hiring Co-Pilot
                    </h3>
              ...
              >
                ...
                <div className="flex gap-2 items-start">
                  ...
                  <div className="bg-white p-3 rounded-xl rounded-tl-none border border-slate-100 max-w-[85%] shadow-sm">
                    <p className="text-[11px] text-slate-700 leading-relaxed font-light">
                      Welcome. I am optimized with{" "}
                      <strong className="text-slate-900 font-medium">
                        {activeDoc.name}
                      </strong>
                      's JSON credential model.
                    </p>
                    <p className="text-[11px] text-slate-600 leading-relaxed mt-1 font-light">
                      Select an analytical suggestion to review details, or type
                      a custom question:
                    </p>
                ...
                {(chatHistories[activeDoc.id] || []).map((msg) => {
                  ...
                  const isPlaceholder =
                    msg.id === typingMessageId && isTyping && !msg.text;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`p-3 rounded-xl max-w-[82%] shadow-sm border relative ${
                          isUser
                ...
                >
                  <input
                    ...
                    placeholder={
                      isTyping
                        ? "Replying..."
                        : "Ask questions about candidate JSON..."
                    }
